export const questions = [
  ...
  {
    text: "Are you planning to work on this business full-time, or will it be a part-time venture alongside other commitments?",
    answer1: "Full-time",
    points1: "1",
  ...
  {
    text: "Have you clearly identified distinct customer segments within your target market, based on both demographic and psychographic data (e.g., age, values, lifestyle)?",
    answer1: "Yes",
    points1: "1",
    answer2: "No",
    points2: "0",
